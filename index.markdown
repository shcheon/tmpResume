...
안녕하세요.<br>
여러 분야의 레거시 프로젝트를 분석하며, S/W 아키텍쳐, 자료구조, 알고리즘을 이해하는 역량을 키워왔으며, 
또한 다양한 개발환경에서의 디버깅을 수행할 수 있는 경험을 보유하고 있습니다.
...
- 개요 : Week 단위의 반도체 생산 계획을 Day 단위로 생산계획을 설비의 Capacity를 고려하여 계획을 생성하는 Backend 서버를 운영함
